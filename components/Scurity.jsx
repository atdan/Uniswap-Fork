...
const Scurity = () => {
  return (<div className="scurity">
    <div className="icon-one">
      <img src="/assets/img/scurity-vector-1.png"/>
    </div>

    <div className="icon-two">
      <img src="/assets/img/scurity-vector-2.png"/>
    </div>
      ...
      <div className="row justify-content-center">
        <div className="col-lg-10 text-center wow fadeInUp"
          ...
          <div className="section-head">
            ...
            <h2 className="title">Security and Compliance</h2>
            <p className="text"></p>
          </div>
        </div>
      </div>
          ...
          <div className="col-xl-4 col-lg-6 wow fadeInUp"
            ...
            <div className="scurity-box one">
              ...
              <div className="content">
                ...
                <p className="text">2 Step Verification</p>
              </div>
            </div>
          </div>
        </div>
